...
import lemurLogo from "@assets/lemur-logo.svg";
    ...
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <Card className="dark:bg-gray-800 border-0 shadow-lg">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Search className="mr-2 h-5 w-5 text-[hsl(var(--primary))]"/> 
              Intelligent Search
            </CardTitle>
            <CardDescription>
        ...
        <Card className="dark:bg-gray-800 border-0 shadow-lg">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Zap className="mr-2 h-5 w-5 text-[hsl(var(--primary))]"/> 
              Advanced AI Models
            </CardTitle>
            <CardDescription>
          ...
          <CardContent>
            ...
            <div className="mt-4 flex gap-2">
              <Badge variant="outline" className="bg-primary/10">llama-3.3-70b-versatile</Badge>
              <Badge variant="outline" className="bg-primary/10">llama-4-scout-17b-16e-instruct</Badge>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
            <Database className="h-10 w-10 mx-auto mb-4 text-[hsl(var(--primary))]"/>
            <h3 className="font-semibold mb-2 dark:text-white">Tavily Search API</h3>
            <p className="text-[hsl(var(--neutral-muted))] text-sm">Powers our web search results with comprehensive coverage</p>
          </div>
          
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
            <Zap className="h-10 w-10 mx-auto mb-4 text-[hsl(var(--primary))]"/>
            <h3 className="font-semibold mb-2 dark:text-white">Groq Inference API</h3>
            <p className="text-[hsl(var(--neutral-muted))] text-sm">Ultra-fast AI model inference for instant answers</p>
          </div>
          
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
            <Code className="h-10 w-10 mx-auto mb-4 text-[hsl(var(--primary))]"/>
            <h3 className="font-semibold mb-2 dark:text-white">React & Vite</h3>
            <p className="text-[hsl(var(--neutral-muted))] text-sm">Modern frontend with responsive design and dark mode</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-primary/5 dark:bg-primary/10 rounded-lg p-8 mb-16">
        ...
        <p className="text-[hsl(var(--neutral-muted))] max-w-3xl mx-auto text-center leading-relaxed">
      ...
      <div className="text-center">
        ...
        <p className="text-[hsl(var(--neutral-muted))] max-w-3xl mx-auto mb-8">
